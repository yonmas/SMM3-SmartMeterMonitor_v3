...
| `lite/` | Alternative main programs (parent + Basic/Core2 children) for meters with short history. `smm3-lite_main_web.py` is the GAS/Web + freeze-defense variant, generated by applying the `smm3_main.py`→`smm3_main_web.py` diff onto `smm3-lite_main.py` (never hardware-tested as of 2026-08-05) |
