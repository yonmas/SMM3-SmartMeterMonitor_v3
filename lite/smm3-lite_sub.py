...
def draw_graph_7():
    ...
    draw_graph(draw_period, bar_width, bar_pitch, gr_start, av_start, draw_data)
...
def draw_graph(draw_period, bar_width, bar_pitch, gr_start, av_start, draw_data):
    ...
    if created_time != '**:**':
        ...
        lcd.rect(0, 0, 320, 224, BG_COLOR, BG_COLOR)
        if draw_period == 13:
            lcd.line(0, 21, 320, 21, 0x303030)
            lcd.line(0, 105, 320, 105, 0x303030)
            lcd.line(0, 203, 320, 203, 0x303030)
        ...
        for i in range(1, draw_period + 1):
            y = (i - 1) * bar_pitch + gr_start
            len_sub_t = int(320 * (daily_sub_t[i] / GRAPH_SCALE))
            len_cumul = int(320 * (daily_cumul[i] / GRAPH_SCALE))
...
# 【page】　＜直近13日間＞との積算電力量比較 表示
def draw_table_13():
    draw_table(13, 'Avg13', 0x2ca02c)
...
if __name__ == '__main__':
    ...
    try:
        ...
        lcd.clear(0)
        lcd.font(lcd.FONT_DejaVu18)
        lcd.println('Welcome to SMM3 lite !', 0, 0, color=0xFF0000)
        ...
        draw_page = [
            ...
            draw_graph_13,  # 電力量グラフ (随時比較・当日と直近13日間)
            draw_table_13   # 積算電力量比較表 (当日と直近13日間平均・1時間毎)
        ]
